...
2.  Target Fishing (*target_fishing*): MPAs locations are prioritized
...
For the coastal coral reef example the *target_fishing* MPA design strategies was capable of producing a Pareto-improving, i.e. potentially win-win, outcome where the total
...
than the *target_fishing* strategy, only benefiting
...
simulated space. The *target_fishing* strategy
...
#| fig-cap: "Frontier in conservation and yield outcomes under different MPA design strategies (A) for coastal coral reef case study. Change in yield for each fleet (B) and depletion per species (C) as a function of MPA size and MPA design strategy for the coral reef case study."
#| fig-height: 4
#| fig-width: 6
...
*status quo* conditions the *target_fishing* MPA design strategy
