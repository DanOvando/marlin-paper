  ...
  fleets <- list("longline" = create_fleet(
    list(
      "katsuwonus pelamis" = Metier$new(
        ...
        price = 1.36,
        sel_form = "logistic",
        sel_start = fauna$`katsuwonus pelamis`$length_50_mature *  sample(c(0.25, 1, 1.75), 1, replace = TRUE),
        sel_delta = 0.01,
        catchability = .1,
        p_explt = 1,
        sel_unit = "length"
      ...
      "kajikia audax" = Metier$new(
        ...
        price = 5.16,
        sel_form = "logistic",
        sel_start = fauna$`kajikia audax`$length_50_mature *  sample(c(0.25, 1, 1.75), 1, replace = TRUE),
        sel_delta = 0.01,
        catchability = .1,
        p_explt = 1,
        sel_unit = "length"
      ...
      "carcharhinus longimanus" = Metier$new(
        ...
        sel_start = fauna$`carcharhinus longimanus`$length_50_mature *
          sample(c(0.25, 1, 1.75), 1, replace = TRUE),
        sel_delta = 0.01,
        catchability = .1,
        p_explt = 1,
        sel_unit = "length"
